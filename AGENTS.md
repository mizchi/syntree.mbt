...
- `src/lezer` - Core syntax tree + highlighter runtime
- `src/lezer_api` - JS export wrapper package
- `js/lezer_api.js` - Convenience JS facade over MoonBit build output
...
moon ide outline src/lezer/types.mbt
```
